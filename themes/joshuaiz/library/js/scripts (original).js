...
jQuery(document).ready(function($){
      $('.home #menu-item-12').mouseenter(function() {
        $(".insert").show();
      });
      $('.home #menu-item-12').mouseleave(function() {
        $(".insert").hide();
      });
      $('.home .insert').mouseover(function() {
        $(this).stop(true, true).show();
      });
      $('.home .insert').mouseleave(function() {
