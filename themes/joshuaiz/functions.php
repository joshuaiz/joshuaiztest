...
function wab_blurb_cpt() {

	$labels = array(
		'name'                => _x( 'Blurbs', 'Post Type General Name', 'text_domain' ),
		'singular_name'       => _x( 'Blurb', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'           => __( 'Blurbs', 'text_domain' ),
		'parent_item_colon'   => __( 'Parent Blurb:', 'text_domain' ),
		'all_items'           => __( 'All Blurbs', 'text_domain' ),
		'view_item'           => __( 'View Blurb', 'text_domain' ),
		'add_new_item'        => __( 'Add New Blurb', 'text_domain' ),
		'add_new'             => __( 'Add New Blurb', 'text_domain' ),
		'edit_item'           => __( 'Edit Blurb', 'text_domain' ),
		'update_item'         => __( 'Update Blurb', 'text_domain' ),
		'search_items'        => __( 'Search Blurbs', 'text_domain' ),
		'not_found'           => __( 'Not found', 'text_domain' ),
		'not_found_in_trash'  => __( 'Not found in Trash', 'text_domain' ),
	);
	$args = array(
		'label'               => __( 'blurb', 'text_domain' ),
		'description'         => __( 'Blurbs for your moms', 'text_domain' ),
		'labels'              => $labels,
